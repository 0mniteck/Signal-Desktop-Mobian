...
### [signal-desktop_7.56.0_arm64.deb](https://github.com/0mniteck/Signal-Desktop-Mobian/blob/7.56.x/builds/release/signal-desktop_7.56.0_arm64.deb)
...
This is the latest release: [`builds/release/signal-desktop_7.56.0_arm64.deb`](https://github.com/0mniteck/Signal-Desktop-Mobian/blob/7.56.x/builds/release/signal-desktop_7.56.0_arm64.deb)
...
./buildscript.sh -i .01 -p master -r 7.56.0
```
...
[Download the `.deb`](https://github.com/0mniteck/Signal-Desktop-Mobian/raw/7.56.x/builds/release/signal-desktop_7.56.0_arm64.deb) to your device, verify the sha512sum, then install:
