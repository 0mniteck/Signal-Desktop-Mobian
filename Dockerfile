...
RUN apt install -y git-lfs libasound2-dev libgtk-3-dev libnss3-dev libpulse-dev rubygems xauth xvfb
RUN gem install fpm
...
RUN cd /Signal-Desktop/ && git checkout --progress --force -B 7.56.x refs/remotes/origin/7.56.x
