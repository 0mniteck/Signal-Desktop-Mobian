...
RUN sed -i s/20.17.0/20.18.0/g /Signal-Desktop/.nvmrc
RUN sed -i s/20.17.0/20.18.0/g /Signal-Desktop/package.json
RUN sed -i s/20.17.0/20.18.0/g /Signal-Desktop/package-lock.json
