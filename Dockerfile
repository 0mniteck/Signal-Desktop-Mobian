...
RUN apt install -y cargo cmake curl rubygems git git-lfs pkg-config libcairo2-dev libgif-dev libjpeg-dev libpango1.0-dev libpixman-1-dev libpulse0 librust-libpulse-sys-dev librsvg2-dev ninja-build protobuf-c-compiler rustc xauth xvfb
