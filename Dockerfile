...
RUN apt install -y git-lfs libcairo2-dev libgif-dev libjpeg-dev libnss3-dev libpango1.0-dev libpixman-1-dev librsvg2-dev libpulse-dev pkg-config rubygems xauth xvfb
RUN gem install fpm
